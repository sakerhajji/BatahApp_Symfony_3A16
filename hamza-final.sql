...
--
-- Hôte : 127.0.0.1
-- Généré le : dim. 05 mai 2024 à 14:35
...
(46, 1, 50, NULL, '2024-05-04 14:14:45'),
(48, 6, 52, NULL, '2024-05-05 14:01:13'),
(48, 1, 54, NULL, '2024-05-05 14:05:45'),
(48, 3, 55, NULL, '2024-05-05 14:08:06');
...
(105, 47, '2024-05-05 02:32:12', 'livraison', 'paiement', 22808, 'En Attente', 'test');
...
(1, '2024-04-02', '2024-04-03', 1, 20, 30, 25, 20, 5),
(2, '2024-04-02', '2024-04-03', 1, 20, 30, 25, 20, 4),
(3, '2024-04-02', '2024-04-03', 1, 20, 30, 25, 20, 6);
...
(1, '2024-05-02', 'en cours', 2, 15),
(2, '2024-05-02', 'en cours', 2, 104);
...
INSERT INTO `location` (`id`, `idLocation`, `type`, `description`, `prix`, `adresse`, `disponibilite`, `likes`) VALUES
(45, 1, 'maison', 'hamza', 1, 'bb', '1', 1);
...
(2, 'test', 'livraison', 'bardo', 95316683, 'test@gmail.com', 'hamza pic3-66342275df42e.jpg', 3);
...
(1, 'Voiture', 'Renault Megane 2023, essence, boîte automatique, 5 places', 22800, 'Renault Megane 2023', 'disponible', 0, 'Renault_Megane_2023.jpg', 'https://www.youtube.com/watch?v=AQ8Wj_RSz6g', 'https://maps.google.com/maps?q=tunis&t=&z=13&ie=UTF8&iwloc=&output=embed', 10, 3, 0, 5, 2),
(3, 'Voiture', 'Audi A4 2023, essence, boîte automatique, 5 places', 50800, 'Audi A4', 'disponible', 0, 'audi_a4.jpg', 'https://www.youtube.com/watch?v=xdct9lGOl_U', 'https://maps.google.com/maps?q=tunis&t=&z=13&ie=UTF8&iwloc=&output=embed', 3, 9, 0, 5, 1),
(4, 'Voiture', 'BMW Serie 3 2022, diesel, boîte manuelle, 5 portes', 55000, 'BMW Serie 3', 'disponible', 1, 'bmw_serie_3.jpg', 'https://www.youtube.com/watch?v=hGdNday0NFo', 'https://maps.google.com/maps?q=Sousse&t=&z=13&ie=UTF8&iwloc=&output=embed', 5, 2, 0, NULL, 3),
(5, 'maison', 'Villa moderne, 4 chambres, 2 salles de bains, jardin spacieux', 350000, 'Villa Moderne', 'disponible', 0, 'villa_moderne.jpg', 'https://www.youtube.com/watch?v=n3wtxcO_0GQ', 'https://maps.google.com/maps?q=Hammamet&t=&z=13&ie=UTF8&iwloc=&output=embed', 2, 0, 0, 0, 5),
...
--
-- Déchargement des données de la table `reservation_enchere`
--

INSERT INTO `reservation_enchere` (`idReservation`, `dateReservation`, `confirmation`, `idUser`, `idEnchere`) VALUES
(1, '2024-04-02', 1, 2, 1);
...
(41, NULL, 'test', 'test', 'H', '2002-04-02', 'test@gmail.com', '$2y$10$84D8jkaicficd.bP5zkvYuI', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-05-03 01:21:47', 'U'),
(42, NULL, 'hamza', 'test', 'H', '2002-02-02', 'battah@gmail.com', '$2y$10$zVtBkUzoLVGZFYZD7jGvlu2', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-05-03 12:40:06', 'U'),
(43, NULL, 'zeineb', 'cherif', 'F', '2002-02-02', 'zeineb@gmail.com', '$2y$10$3FdM1MbFLrqwFp6FYb7CAuf', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-05-04 10:59:31', 'U'),
(44, NULL, 'a', 'a', 'H', '2002-02-02', 'a1@gmail.com', '$2y$10$xqYUriE2BcawGo15U7T6F.d', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-05-04 11:03:51', 'U'),
(45, NULL, 'a', 'a', 'H', '2002-02-02', 'a1@gmail.com', '$2y$10$xqYUriE2BcawGo15U7T6F.d', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-05-04 11:03:51', 'U'),
(46, NULL, 'hamza', 'a', 'H', '2002-02-02', 'a2@gmail.com', '$2y$10$knyy1HXhmR9m.EbsndbiauK', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-05-04 12:57:49', 'U'),
(47, NULL, 'test ', 'aa', 'H', '2002-02-02', 'test4@gmail.com', '$2y$10$gFjrFJuU79cYz35Gh..8Ne5', 'bardo', '95316683', '12345678', 'Béja', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '6636d34c72abb.jpg', '2024-05-04 23:40:19', 'U'),
(48, NULL, 'test', 'a', 'H', '2002-02-02', 'a4@gmail.com', '$2y$10$5PktrRCbwhU1QR1qqlFnyOr', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2024-05-05 13:21:12', 'U');
...
--
ALTER TABLE `basket`
  MODIFY `idBasket` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
...
--
ALTER TABLE `encheres`
  MODIFY `idEnchere` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `reservation_location`
  MODIFY `id_reservation_location` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `views`
  MODIFY `idViews` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `reservation_location`
  ADD CONSTRAINT `fk_reservation_location_location` FOREIGN KEY (`idLocation`) REFERENCES `location` (`idLocation`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_reservation_location_utilisateur` FOREIGN KEY (`idUtilisateur`) REFERENCES `utilisateur` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
